...
class Planner(yarp.RFModule):
    ...
    def updateModule(self):
        ...
        if text_input == "":
            ...
            self._send_message_to_output_port("user", text_input)
        ...
        if obs_fb_input == 'No significant changes in the scene.' or obs_fb_input == "":
            ...
            self._send_message_to_output_port("observer", obs_fb_input)
        ...
        if intState_input == 'Nothing is running' or intState_input == 'Nothing is running.' or intState_input == "":
            ...
            self._send_message_to_output_port("internal", intState_input)
                ...
                for tcs in actions_:
                    ...
                    for tc in tcs:
                        ...
                        if done: 
                            ...
                            self._send_message_to_output_port("tool", f'Result:  {fn_res} ', name=func)
